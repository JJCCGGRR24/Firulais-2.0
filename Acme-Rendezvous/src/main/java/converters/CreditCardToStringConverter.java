	...
	public String convert(final CreditCard creditCard) {
		...
		if (creditCard == null)
			...
			try {
				...
				builder.append("|");
				builder.append(URLEncoder.encode(String.valueOf(creditCard.getCVV()), "UTF-8"));
				builder.append("|");
				builder.append(URLEncoder.encode(String.valueOf(creditCard.getExpirationMonth()), "UTF-8"));
				builder.append("|");
				builder.append(URLEncoder.encode(String.valueOf(creditCard.getExpirationYear()), "UTF-8"));
