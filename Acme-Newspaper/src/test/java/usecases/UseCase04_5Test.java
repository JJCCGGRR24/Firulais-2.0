...
public class UseCase04_5Test extends AbstractTest {
	...
	public void driver() {
		final Object testingData[][] = {
			//Intentamos buscar un periódico mediante una palabra sin autenticarnos, y el resultado debe ser positivo.
			{

				null, "galleta", null
			},
			//Intentamos buscar un periódico mediante una palabra autenticados como customer, y el resultado debe ser negativo.
			{

				" customer80", "galleta", IllegalArgumentException.class
			},
			//Intentamos buscar un periódico mediante una palabra autenticados como user, y el resultado debe ser negativo.
			{
